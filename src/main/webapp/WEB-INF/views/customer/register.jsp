...
<head>
    ...
    <link href="${APP_PATH}/css/register.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="${APP_PATH}/js/addr.js"></script>
    ...
    <script type="text/javascript">
        ...
        function check() {
            ...
            if (!result || document.getElementById("span1").innerHTML == "用户名不可用"){
                return false;
            }
...
<div class="container header">
    ...
    <div class="span9">
        <div class="headerAd">
            <img src="${APP_PATH}/image/header.jpg"
        ...
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" method="post"
                      action="${APP_PATH}/userRegist" onsubmit="return check()"
                >
                    <table>
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <%--<input type="text" name="addr" class="text"
                                       maxlength="200">--%>
                                    <select id="cmbProvince" name="addrP"></select>
                                    <select id="cmbCity" name="addrC"></select>
                                    <select id="cmbArea" name="addrA"></select>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="login">
                        ...
                        <dl>
                            <dt>已经拥有账号了？</dt>
                            <dd>
                                立即登录即可体验在线购物！ <a href="${APP_PATH }/getLogin" >立即登录</a>
                            </dd>
                        </dl>
                    </div>
                </form>
